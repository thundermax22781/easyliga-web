...
export default function GroupDetailScreen() {
  ...
  const renderBracket = () => {
    ...
    const phases = [
      ...
      { id: 'semifinal', title: 'Semifinali', icon: 'trophy-outline', color: '#FF9500', matches: knockoutMatches.filter(m => m.match_phase === 'semifinal') },
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
          ...
          <ViewShot ref={viewShotRef} options={{ format: "png", quality: 1.0 }} style={{ backgroundColor: isDarkMode ? '#111111' : '#F8F9FF', padding: sharing ? 12 : 10 }}>
            <View style={styles.teamsContainer}>
              {sharing && (
                <View style={{ marginBottom: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: isDarkMode ? '#1C1C1E' : '#FFFFFF', padding: 12, borderRadius: 18, borderWidth: 1, borderColor: isDarkMode ? '#333' : '#E5E5EA' }}>
                  <View style={{ flex: 1 }}>
                  ...
                  <View style={{ width: 54, height: 54, borderRadius: 27, overflow: 'hidden', backgroundColor: '#FFF', borderWidth: 2, borderColor: '#007AFF', marginLeft: 10 }}>
